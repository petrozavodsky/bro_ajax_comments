...
class bro_ajax_comments_change_defaults {
	...
	public function __construct() {
		...
		add_filter( 'wp_list_comments_args', array( __CLASS__, 'wp_list_comments_args_filter' ) );
	...
	public static function comment_form_before_fields_filter() {
		echo "<div class='comments__fields'>";

	}

	public static function comment_form_after_fields_filter() {
		echo "</div>";
	}
