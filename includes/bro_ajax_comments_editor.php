...
class bro_ajax_comments_editor
{
    ...
    {
        $this->file = $file;
        add_action("wp_enqueue_scripts", array($this, "add_js_css"), 10, 1);
    }

    public function add_js_css()
    {
        wp_enqueue_style("trumbowyg", plugin_dir_url($this->file) . "public/js/vendor/trumbowyg/dist/ui/trumbowyg.min.css", array(), '2.3.0', 'all');
        ...
        wp_enqueue_script("bro_ajax_comments_editor", plugin_dir_url($this->file) . "public/js/editor.js", array("bro_ajax_comments_js", "trumbowyg"), $this->version, true);
