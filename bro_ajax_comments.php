...
class bro_ajax_comments
{
    ...
    public function __construct()
    {
        ...
        add_action('comment_form_defaults', array($this, "change_comment_form_action"), 15, 1);
    ...
    public function add_js_css()
    {
        ...
        wp_enqueue_script('bro_ajax_comments_js', plugin_dir_url(__FILE__) . "public/js/ajax-comments.js", array("jquery", "bro_ajax_comments_save_in_local_storage"), $this->version, true);
    ...
    private function insert_comment($request)
    {
        ...
        $comment = wp_handle_comment_submission($comment_submission_args);
        return $comment;
    }


    public function change_comment_form_action($args)
    {
        $args['action'] = admin_url("admin-ajax.php?action={$this->ajax_action_field}");
        return $args;
    }
}
