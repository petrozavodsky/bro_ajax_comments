...
e.extend(!0,e.trumbowyg,{langs:{en:{emoji:"Add an emoji"},fr:{emoji:"Ajouter un emoji"}},plugins:{emoji:{init:function(r){r.o.plugins.emoji=e.extend(!0,{},o,r.o.plugins.emoji||{});var i={dropdown:a(r)};r.addBtnDef("emoji",i)}}}})}(jQuery);